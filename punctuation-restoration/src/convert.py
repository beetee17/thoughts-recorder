...
parser = argparse.ArgumentParser(description='Punctuation restoration Pytorch to CoreML conversion')
parser.add_argument('--save-path', default='out/', type=str, help='model save path')
parser.add_argument('--weight-path', default='weights.pt', type=str, help='model weight path relative to save-path')

args = parser.parse_args()
save_path = args.save_path

model_save_path = os.path.join(save_path, args.weight_path)
